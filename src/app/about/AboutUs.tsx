  ...
  return (
    <div>
      ...
      <section className="text-white body-font">
        <div className="container mx-auto flex px-5 py-24 flex-col md:flex-row">
          {/* Left Image */}
          <div className="flex flex-col md:flex-row items-center md:space-x-4 mt-2">
            <Image
              className="object-cover object-center w-full md:w-[309px] h-auto md:h-[536px] mb-4 md:mb-0 rounded-lg"
              alt="hero"
              src="/about1.png"
              width={309}
              height={536}
          ...
          {/* Right Images */}
          <div className="flex flex-col space-y-4 md:space-y-2 md:mt-0 mt-4">
            <Image
              className="object-cover object-center w-full md:w-[309px] h-auto md:h-[271px] mb-4 rounded-lg"
              alt="image2"
              src="/youget.png"
              width={309}
              height={271}
            ...
            {/* Bottom Image */}
            <Image
              className="object-cover object-center w-full md:w-[309px] h-auto md:h-[382px] mb-4 rounded-lg"
              alt="image3"
              src="/youget2.png"
              width={309}
              height={382}
      ...
      <section className="text-white body-font">
        <div className="container mx-auto flex flex-col items-center justify-center px-5 py-24">
          ...
          <Image
            className="object-cover object-center w-full md:w-[1320px] h-auto md:h-[386px] mt-10 rounded-lg"
            alt="hero"
            src="/about.png"
            width={1320}
            height={386}
